...
namespace WindowsFormsApplication1
{
    public partial class MH_tool : Form
    {
        ...
        private void comboBox_SysEng_TextChanged(object sender, KeyPressEventArgs e)
        {
            if (char.IsLetterOrDigit(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar))
            {// Handle printable characters (letters, numbers, symbols, punctuation).             
                comboBox_get_emails(comboBox_SysEng);
            }
            else if (string.IsNullOrEmpty(comboBox_SysEng.Text))
            {//Hide the dropdown when there's no input.
                comboBox_clear_emails(comboBox_SysEng);
            }
        }
        private void comboBox_HrdwEng_TextChanged(object sender, KeyPressEventArgs e)
        {
            if (char.IsLetterOrDigit(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar))
            {// Handle printable characters (letters, numbers, symbols, punctuation).             
                comboBox_get_emails(comboBox_HrdwEng);
            }
            else if (string.IsNullOrEmpty(comboBox_HrdwEng.Text))
            {//Hide the dropdown when there's no input.
                comboBox_clear_emails(comboBox_HrdwEng);
            }
        }
        private void comboBox_ControlEng_TextChanged(object sender, KeyPressEventArgs e)
        {
            if (char.IsLetterOrDigit(e.KeyChar) || char.IsSymbol(e.KeyChar) || char.IsPunctuation(e.KeyChar))
            {// Handle printable characters (letters, numbers, symbols, punctuation).             
                comboBox_get_emails(comboBox_ControlEng);
            }
            else if (string.IsNullOrEmpty(comboBox_ControlEng.Text))
            {//Hide the dropdown when there's no input.
                comboBox_clear_emails(comboBox_ControlEng);
            }
        }
        ...
        private bool CreateProject()
        {
            ...
            try
            {
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/FieldEngineerManager");
                    return false;
                }
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/HardwareManager");
                    return false;
                }
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/SoftwareManager");
                    return false;
                }
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/CrainDirectorOwner");
                    return false;
                }
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/WarrantyUser");
                    return false;
                }
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/MPROwner");
                    return false;
                }
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/MaxViewRT");
                    return false;
                }
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/VOIPOwner");
                    return false;
                }
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/SPLCOwner");
                    return false;
                }
                ...
                if (curNode == null)
                {
                    _ = MessageBox.Show("Problem with ProjectEmail.xml/Configuration/MaxviewQCOwner");
                    return false;
                }
                ...
                using (WebClient wb = new WebClient())
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                _ = MessageBox.Show("Failed to match entered eng" +
                            ...
                            {
                                _ = MessageBox.Show("Failed to match one or more of the input engineer emails. Please make sure each entry is correct. Check the ProjectEmail.xml as well.", "Error!");
                                return false;
                            }
                            else if (response.Contains("<title>Authorization Required</title>"))
                            {
                            ...
                            {
                                _ = MessageBox.Show("Unexpected response. Unsure of success.  Ending Project Creation");
                                return false;
                            }
                        ...
                        {
                            _ = MessageBox.Show("Invalid Username Or Password.", "Warning!");
                            return false;
                        }
                        if (getToken.Contains("<title>Authorization Required</title>"))
                        {
                            _ = MessageBox.Show("This utility requires Administrative rights.", "Authorization Required");
                            return false;
                        }
                        if (getToken.Contains("<title>Untrusted Authentication Request</title>"))
                        {
                            _ = MessageBox.Show("Bugzilla returned the Untrusted Authentication Request page. Failed to create project.");
                            return false;
                        }
                        ...
                        {
                            _ = MessageBox.Show("Failed to match entered engineer email. Please make sure each entry is correct. Check the ProjectEmail.xml as well.", "Error");
                            return false;
                        }
                        if (response.Contains("<title>Untrusted Authentication Request</title>"))
                        {
                    ...
                    {
                        _ = MessageBox.Show("Exception thrown while creating project", "Error");
                        return false;
                    }
                    try
                    {
